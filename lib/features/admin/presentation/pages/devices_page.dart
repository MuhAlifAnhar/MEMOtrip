...
class DevicesPage extends StatelessWidget {
            ...
            ...List.generate(sensors.length, (i) {
              ...
              return TweenAnimationBuilder<double>(
                ...
                child: Container(
                  ...
                  padding: EdgeInsets.all(isNarrow ? AppSpacing.base : AppSpacing.xl),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        // Sensor Data — responsive
                        isNarrow
                            ? _buildMobileSensors(s, d)
                            : _buildDesktopSensors(s, d),
                        const SizedBox(height: AppSpacing.lg),
                        // Camera Snapshot
                        Container(
  ...
  Widget _buildDesktopSensors(dynamic s, dynamic d) {
    return Row(children: [
      Expanded(
